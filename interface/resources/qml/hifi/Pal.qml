...
Rectangle {
    ...
    color: "#E3E3E3"
    // Properties
    property int myCardHeight: hifi.dimensions.itemSize*1.5
    property int rowHeight: hifi.dimensions.itemSize
    property int actionButtonWidth: hifi.dimensions.itemSize*1.7
    ...
    property var userModel: UsersModel
    property var userModelSorted: UsersModelSorted
    ...
    Rectangle {
        ...
        HifiControls.Table {
            ...
            itemDelegate: Item {
                ...
                HifiControls.Button {
                    ...
                    visible: isButton
                    anchors.centerIn: parent
                    width: hifi.dimensions.buttonSize*1.3
                    height: hifi.dimensions.buttonSize
                    onClicked: {
            ...
            headerDelegateComponent: tableHeaderComp

            Component {
                id: tableHeaderComp
                HifiControls.TableHeaderDelegate {
                    id: hdrDelegate
                    parentTable: table
                }
            }
            ...
            Item {
                ...
                x: table.__listView.visibleArea.xPosition
                y: table.__listView.visibleArea.yPosition
            ...
            Item {
                ...
                width: 20
                height: hifi.dimensions.buttonSize
                x: nameCardWidth - hifi.fontSizes.tableHeadingIcon - hifi.dimensions.tablePadding
                y: table.__listView.visibleArea.yPosition
                ...
                MouseArea {
                    ...
                    onEntered: item.helpText.color = hifi.colors.baseGrayHighlight
                    onExited: item.helpText.color = hifi.colors.darkGray
                }
            }
        } //table
        ...
        HifiControls.Keyboard {
            ...
            numeric: palContainer.punctuationMode
            anchors {
    ...
    function findSessionIndex(sessionId, optionalData) { // no findIndex in .qml
        return UsersModel.findSessionIndex(sessionId);
    }
    ...
    function fromScript(message) {
        ...
        case 'users':
            ...
            var usrnum = UsersModel.setUsers(data)
            UsersModelSorted.sourceModel = UsersModel
            var index = -1;
    ...
    function sortModel() {
        ...
        //TODO: set sort properties for model
...
//        });
        ...
        //userModel.clear();
//        var userIndex = 0;
//        userModelData1.forEach(function (datum) {
